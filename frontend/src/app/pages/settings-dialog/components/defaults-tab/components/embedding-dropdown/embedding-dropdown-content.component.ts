...
export class EmbeddingDropdownContentComponent {
  @Input() models: FullEmbeddingConfig[] = [];
  @Input() selectedModelId: number | null = null;
  @Output() modelSelected = new EventEmitter<FullEmbeddingConfig>();
  @Output() close = new EventEmitter<void>();

  public searchTerm: string = '';
  public filteredModels: FullEmbeddingConfig[] = [];
  ...
  public selectModel(model: FullEmbeddingConfig): void {
