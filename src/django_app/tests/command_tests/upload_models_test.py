...
def test_upload_llm_models(llm_model_name, llm_provider_name):
    ...
    LLMModel.objects.get(name=llm_model_name, llm_provider__name=llm_provider_name)
...
def test_upload_embedding_models(name, embedding_provider_name):
    ...
    EmbeddingModel.objects.get(name=name, embedding_provider__name=embedding_provider_name)
