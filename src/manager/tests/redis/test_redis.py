...
class TestRedis:
    ...
    @pytest.mark.asyncio
    async def test_start_session(self, mocker: MockerFixture):
        redis_service = RedisService(session_start_channel="test:sessions:start")
    ...
    @pytest.mark.asyncio
    async def test_publish_session_status(self, mocker):
