...
if os.environ.get("MONITORING_MODE") == None:
    os.environ['MONITORING_MODE'] = "local"


if os.environ.get("MONITORING_LOCAL_PATH") == None:
    os.environ['MONITORING_LOCAL_PATH'] = os.path.join(os.getcwd(), "telemetry_log")
